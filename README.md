...
- **Vintage 3:** The dataset was last updated in March 2026 of 2025 to cover data that ended in 2025:11 (MSC), 2025:11 (SCE), and 2025:11 (CES), ECB Euro area HICP by country (2025:12). The MSC residualised disagreement figures now account for political affiliation interacted with the party in power. The data includes two residualised options for the MSC: a long sample without, and a shorter sample when this variable becomes available. 
...
<table>
  ...
  <tr style="background-color: #f5f5f5;">
    <td style="border: 2px solid #68b684; padding: 8px;"><code>*_power</code></td>
    <td style="border: 2px solid #68b684; padding: 8px;">Residualised answers including whether the supported political party is in power, only available for MSC and without gaps from February 2017.</td>
  </tr>
</table>
...
Note: Information on respondent political affiliation in MSC becomes available without gaps from February 2017. We hence include it only in the last subsample.
